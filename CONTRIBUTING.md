...
Any kind of contribution to **My Template Project** is welcome, from a simple comment or a question, to a full fledged [pull request](https://help.github.com/articles/about-pull-requests/). You can reach out the maintainers via [maintainer@utwente.nl](mailto:maintainer@utwente.nl)
...
If you are a part of My Template Project team and have write access to My Template Project GitHub repository, skip to the next subsection [Develop your contribution](CONTRIBUTING.md#develop-your-contribution). If you are a first-time contributor, follow the below steps:

1. Go to root of this repository and click on 'Fork'. This will create a copy of My Template Project repository in your GitHub account. 
...
1. Now, `git remote -v` will show two remote repositories named:
    ...
    * `upstream`, which refers to My Template Project repository 
...
1. Push your feature branch to your fork of My Template Project GitHub repository.
